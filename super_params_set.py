...
own_parser = argparse.ArgumentParser(description='cellpose parameters')
# preprocess settings : patch_size, patch_overlap_size
patch_args = own_parser.add_argument_group("patch arguments")
...
# data path params
data_args = own_parser.add_argument_group("data arguments")
data_args.add_argument('--data_path', default=r'.\data/', help='user data path')
data_args.add_argument('--model_save', default=r'.\demo_infer\model_deconv_16_2/', help='user model path')
data_args.add_argument('--test_while_train_path', default=r'.\data\test_while_train/', help='data to track your training results')

# Common params for model in training and inference
common_args = own_parser.add_argument_group("common arguments")
...
# train settings
train_set_args = own_parser.add_argument_group("train setting arguments")
...
test_set_args = own_parser.add_argument_group("inference setting arguments")
